...
const DICT = {
  ...
  'Reynolds radii': ['Reynolds radii', '三力半径'],
  'avoidance ray': ['avoidance ray', '避障射线'],
  ...
  'blind cone (field of view)': ['blind cone (field of view)', '视锥盲区'],
  'hunting radii + target': ['hunting radii + target', '捕食半径 + 当前目标'],
  'threat + signal radii': ['threat + signal radii', '威胁半径 + 信号半径'],
  运动: ['Motion', '运动'],
