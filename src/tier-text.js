    ...
    sections: [
      {
        ...
        list: [
          ...
          'Mapping by swerving, from Echo Cartography, a past project of mine (the next page). A fish that swerves around something has in effect measured how far away it is; many swerves add up to a map of places no camera has seen. Once the tank has things in it to find, I want to bring that into flocks.',
        ],
      },
      {
